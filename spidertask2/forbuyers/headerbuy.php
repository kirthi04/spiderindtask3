...
<li><form action="results.php" method="POST"><div class="hopu">  
<input type="text" name="queryy" placeholder="SEARCH" class="hopu">
<input type="hidden" name="searcher_id" value="<?php echo$userid1; ?>" class="hopu">

  <button type="submit" name="serch">SUBMIT</button>
</div>
</form></li>
